        ...
        <div className='container'>
          <div className='row justify-content-center'>
            <div className='col-md-11'>
              <div className='row'>
                <div className='card card-body col-md-5 shadow mx-auto' data-aos="zoom-in">
                ...
                <div className='col-md-6'>
                  <div className='row d-flex justify-content-evenly'>
                    <div className='card col-md-11 moving-text-container mb-3 ms-4 shadow' data-aos="zoom-in">
                    ...
                    <div className='card col-md-5 shadow-lg' data-aos="zoom-in">
          ...
          <div className='row justify-content-center mt-4'>
            <div className='col-md-11'>
              <div className='row d-flex align-items-start'>
                <div className='col-md-7 card card-body shadow me-3 ' data-aos="zoom-in">
                  <div className='row d-flex justify-content-evenly'>
                ...
                <div className='col-md-2 card card-body shadow ms-2' data-aos="zoom-in">
                  <p className='text-light'>Let's Explore Together
                    <FcIdea />
                  </p>
                  <Carousel>
                    <Carousel.Item>
                      <img src={Bird} alt="Bird 1" style={{ width: '100%', height: '100%' }} />
                    </Carousel.Item>
                    <Carousel.Item>
                      <img src={Bird2} alt="Bird 2" style={{ width: '100%' }} />
                    </Carousel.Item>
                    <Carousel.Item>
                      <img src={Bird3} alt="Bird 3" style={{ width: '100%' }} />
                    </Carousel.Item>
                  </Carousel>
                </div>
              </div>
